...
async function init() {
  ...
  chrome.runtime.onMessage.addListener((message, _sender, _sendResponse) => {
    if (message?.type === TB_TOGGLE_BOOKMARKS_PANE) {
      // TODO: If the page currently shows other session info, switch to the current tab info.
      // TODO: instead of invoking click event, call the actual implementation directly.
